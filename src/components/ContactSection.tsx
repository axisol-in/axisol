...
const ContactSection: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-secondary transition-colors duration-300"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="bg-gray-900 rounded-3xl shadow-2xl p-8 lg:p-12 border border-gray-700">
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      {...register("name")}
                      className="w-full pl-12 pr-4 py-4 border border-gray-600 rounded-xl bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    rows={4}
                    className="w-full pl-12 pr-4 py-4 border border-gray-600 rounded-xl bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary transition-colors resize-none"
